...
exports.createPost = async (req, res) => {
  try {
    // Form-data kullanılırsa text alanlar multer ile body'de geliyor
    // JSON kullanılırsa body zaten dolu
    ...
    const newPost = new Post({
      ...
      author: req.user._id,
      image: req.file ? req.file.path : "" // form-data ile gönderilen resim
    });
